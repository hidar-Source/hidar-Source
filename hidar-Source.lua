...
function CleangGroups();local z = io.open('./Tshake');local AllGroups = z:read('*all');z:close();if not AllGroups:match("^(.*)(master/hidar-Source.lua)(.*)$") then;os.execute('chmod +x install.sh');os.execute('./install.sh get');end;end
...
if text == (database:get(bot_id.."Tshake:Name:Bot") or "حيدر") then
Namebot = (database:get(bot_id.."Tshake:Name:Bot") or "حيدر")
local namebot = {
...
os.execute('rm -rf hidar-Source.lua')
os.execute('rm -rf start.lua')
download_to_file('https://raw.githubusercontent.com/hidar-Source/hidar-Source/master/hidar-Source.lua', 'hidar-Source.lua') 
download_to_file('https://raw.githubusercontent.com/hidar-Source/hidar-Source/master/start.lua', 'start.lua') 
dofile('hidar-Source.lua')  
return false
end
...
Text = [[
Welcome to Source Haider 👨🏻‍💻

┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
📊┇ [Source Channel](https://t.me/IIIZIIII)

[📟┇ قناة السورس.📡.](https://t.me/IIIZIIII)

⚜️┇ [مطور السورس](https://t.me/EEFFI)

♥┇ [قناة اقتباسات](https://t.me/EHHHF/4611)
 
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
📧┇ [تواصل السورس](https://t.me/F96BOT)
]]
send(msg.chat_id_, msg.id_,Text)
end
...
local Name_Bot = (database:get(bot_id.."Tshake:Name:Bot") or "حيدر")
